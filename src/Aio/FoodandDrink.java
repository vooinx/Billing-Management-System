 ...
 * @author Fancysx
 */
public class FoodandDrink extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Submenu.setText("Master Data > Food and Drink");
        ...
        add(Submenu, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 20, 220, 38));

        icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Src/Restaurant Menu.png"))); // NOI18N
        add(icon, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 20, -1, 38));
        ...
        add(Updatebtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 520, 90, 30));
    ...
    private void UpdatebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdatebtnActionPerformed
        ...
        if(Menu.getText().equals("")){
            ...
            if(jawab == 0){
                try{
                    Statement st = conn.createStatement();
                    st.executeUpdate("UPDATE food_drink SET Menu = '" + menu + "', Harga = '" + price + "', Stock = '" + status + "', Jenis = '" + category + "' WHERE Product_id = '" + selectedId + "'");
    ...
    private void DeletedbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeletedbtnActionPerformed
        ...
        if(Menu.getText().equals("")){
            JOptionPane.showMessageDialog(new JFrame(), "Silahkan pilih menu produk yang akan dihapus!", "Warning", JOptionPane.WARNING_MESSAGE);
        }else{
            int jawab = JOptionPane.showConfirmDialog(null, "Produk ini akan dihapus, lanjutkan ?", "Konfirmasi", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
            if(jawab == 0){
                try{
                    Statement st = conn.createStatement();
                    st.executeUpdate("DELETE FROM food_drink WHERE Menu = '" + Menu.getText() + "'");
    ...
    private void SubmenuMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SubmenuMouseEntered
        String s = "<HTML><u>Master Data > Food and Drink</u></HTML>";
        Submenu.setText(s);
    ...
    private void SubmenuMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SubmenuMouseExited
        String s = "Master Data > Food and Drink";
        Submenu.setText(s);
