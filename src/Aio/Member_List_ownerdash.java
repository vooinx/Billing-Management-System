 ...
 * @author Fancysx
 */
public class Member_List_ownerdash extends javax.swing.JPanel {
   ...
   private void Table_MemberMouseClicked(java.awt.event.MouseEvent evt) {    
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 160, 908, -1));

        jSeparator1.setForeground(new java.awt.Color(27, 34, 45));
        add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, 908, 7));

        icon_memberlist.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Src/people list.png"))); // NOI18N
        add(icon_memberlist, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 70, -1, -1));
        ...
        add(Data_member, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 90, -1, -1));

        jLabel2.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(27, 34, 45));
        jLabel2.setText("NET™");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 100, 46, -1));
        ...
        add(Print, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 630, -1, -1));

        jSeparator2.setForeground(new java.awt.Color(27, 34, 45));
        add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 600, 908, 7));
        ...
        add(showDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 80, 85, -1));
        ...
        add(showTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 110, 85, -1));
        ...
        Submenu.setText("Master Data > List Member");
        ...
        add(Submenu, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 30, -1, -1));
    ...
    private void SubmenuMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SubmenuMouseEntered
        String s = "<HTML><u>Master Data > List Member</u></HTML>";
        Submenu.setText(s);
    ...
    private void SubmenuMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SubmenuMouseExited
        String s = "Master Data > List Member";
        Submenu.setText(s);
